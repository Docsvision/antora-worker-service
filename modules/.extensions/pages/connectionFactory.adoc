...
+
. Создайте раздел с произвольным именем в реестре ОС, например `{hklm-dv}WorkerService\Connections\SmtpConnect`.
+
...
+
.. Создайте раздел с произвольным именем в реестре ОС, например `{hklm-dv}WorkerService\Roles\RoleWithSmtpConnect`.
+
...
+
. Создайте раздел с произвольным именем в реестре ОС, например `{hklm-dv}WorkerService\Roles\WorkerProcesses\WpSmtpConnect`.
+
